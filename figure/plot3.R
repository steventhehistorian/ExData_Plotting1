## Yo, Yo, Yo, Whatup - This is the script for the Coursera/ Johns Hopkins "Exploratory Data Analysis" week 1 assignment, plot 3 of 4.
...
# legend(2007-02-01,33, legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), 
#        lty = (c(1,1,1)),
